    ...
    Wilq32.PhotoEffect = (function () {
        ...
        if (supportedCSS) {
            ...
            return function (img, parameters) {
                ...
                //libsh,20130304,处理ie下兼容性问题
                var parent = img.parentNode;
                if (parent) {
                    parent.insertBefore(this._rootObj, img);
                } else {
                    var t = document.getElementById(img.id);
                    if (t)
                        parent = t.parentNode;
                }
        ...
        _Loader: (function () {
            if (IE)
                return function (parameters) {
                    ...
                    //libsh,20130304,处理ie下兼容性问题
                    var parent = this._img.parentNode;
                    if (parent) {
                        parent.removeChild(this._img);
                    }
                    else {
                        t = document.getElementById(this._img.id);
                        if (t)
                            parent = t.parentNode;
                    }
