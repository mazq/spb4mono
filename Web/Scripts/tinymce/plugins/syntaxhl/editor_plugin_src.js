        ...
        */
        init: function (ed, url) {
            ...
            ed.onInit.add(function () {
                ed.dom.loadCSS(url + '/syntaxHighlighter/styles/shCore.css');
                ed.dom.loadCSS(url + '/syntaxHighlighter/styles/shThemeDefault.css');
                var doc = ed.contentDocument;
                var jsArray = new Array("shCore.js", "shLegacy.js", "shBrushAllLanguage.js");
                for (var i = 0; i < 3; i++) {
                    var script = doc.createElement('script');
                    script.src = url + '/syntaxHighlighter/scripts/' + jsArray[i];
